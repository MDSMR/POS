...
<?php $active='rewards'; require __DIR__.'/../../../partials/admin_nav.php'; ?>

<div class="container">
  <?php if($bootstrap_warning): ?><div class="section small"><?= htmlspecialchars($bootstrap_warning,ENT_QUOTES,'UTF-8') ?></div><?php endif; ?>
  <?php if($db_msg): ?><div class="section small">DEBUG: <?= htmlspecialchars($db_msg,ENT_QUOTES,'UTF-8') ?></div><?php endif; ?>
