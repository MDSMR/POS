...
$bootstrap_path = dirname(__DIR__, 3) . '/config/db.php'; // rewards -> admin -> views -> (..)-> config/db.php
...
.tile{display:block;border:1px solid var(--border);border-radius:12px;padding:12px;text-decoration:none;color:inherit;background:#fff}
