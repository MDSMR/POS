<?php
// public_html/views/admin/rewards/stamp/issued.php
...
if(!$bootstrap_ok){ echo "<h1>Stamp – Issued</h1><div style='color:red;'>$bootstrap_warning</div>"; exit; }
...
$page_title="Rewards · Stamp · Issued";
...
<div class="container mt-4">
  ...
  <h1 class="mb-2">Stamp · Issued Rewards</h1>
  <p class="text-muted">Rewards granted after card completion.</p>

  <?php stamp_tabs('issued'); ?>
  ...
  <div class="card shadow-sm"><div class="card-body">
    <form class="row g-3 mb-3">
      ...
      <div class="col-md-2"><label class="form-label">Status</label><select name="status" class="form-select"><option value="">Any</option><option>Pending</option><option>Redeemed</option><option>Expired</option></select></div>
      <div class="col-md-1 d-flex align-items-end"><button class="btn btn-outline-secondary w-100">Filter</button></div>
    </form>

    <div class="table-responsive">
      <table class="table table-sm table-striped align-middle">
        <thead><tr><th>Date</th><th>Member</th><th>Reward</th><th>Status</th><th>Order</th><th>By</th><th></th></tr></thead>
        <tbody><!-- rows --></tbody>
      </table>
    </div>
