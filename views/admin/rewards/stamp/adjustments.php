<?php
// public_html/views/admin/rewards/stamp/adjustments.php
...
if(!$bootstrap_ok){ echo "<h1>Stamp – Adjustments</h1><div style='color:red;'>$bootstrap_warning</div>"; exit; }
...
$page_title="Rewards · Stamp · Adjustments";
...
<div class="container mt-4">
  ...
  <h1 class="mb-2">Stamp · Adjustments</h1>
  <p class="text-muted">Grant or revoke stamps and rewards with audit log.</p>

  <?php stamp_tabs('adjust'); ?>

  <div class="row">
    <div class="col-lg-5">
      <div class="card shadow-sm mb-4"><div class="card-body">
        <h5 class="card-title">New Adjustment</h5>
        <form method="post" action="/controllers/admin/rewards/stamp/adjustment_create.php" class="row g-3">
          ...
          <div class="col-md-6"><label class="form-label">Action</label><select name="action" class="form-select"><option value="stamp_credit">Stamp Credit (+)</option><option value="stamp_debit">Stamp Debit (−)</option><option value="reward_issue">Issue Reward</option><option value="reward_revoke">Revoke Reward</option></select></div>
          <div class="col-md-6"><label class="form-label">Quantity</label><input type="number" name="qty" class="form-control" min="1" value="1"></div>
      ...
      <div class="card shadow-sm"><div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-sm table-striped align-middle">
            <thead><tr><th>Date</th><th>Member</th><th>Action</th><th class="text-end">Qty</th><th>Reason</th><th>By</th><th></th></tr></thead>
            <tbody><!-- rows --></tbody>
          </table>
        </div>
