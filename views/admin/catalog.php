<?php
// public_html/views/admin/catalog.php — Catalog index (entry page)
// Safe bootstrap + session (same pattern as other pages)
...
<head>
<meta charset="utf-8">
<title>Catalog · Smorll POS</title>
...
<?php $active='catalog'; require __DIR__ . '/../partials/admin_nav.php'; ?>
...
<div class="container">
  ...
  <div class="h1">Catalog</div>
  <div class="grid">
    <a class="tile" href="/views/admin/products.php">
      <div class="t-title">Products</div>
      <div class="t-desc">Create and manage menu items sold at the POS.</div>
    </a>
    <a class="tile" href="/views/admin/categories.php">
      <div class="t-title">Categories</div>
      <div class="t-desc">Organize items into menu sections and control the sort order.</div>
    </a>
    <a class="tile" href="/views/admin/modifiers.php">
      <div class="t-title">Modifiers &amp; Options</div>
      <div class="t-desc">Add-ons (sizes, extras, spice level), required and optional choices.</div>
    </a>
  </div>
</div>
</body>
